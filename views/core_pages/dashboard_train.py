...
import callbacks.core_pages_c.dashboard_train_c
from views.core_pages import dashboard_train_charts
            ...
            [
                html.Div(id="train-main-bg-div",
                        children=[
                            ...
                            html.Div(
                                id="main-bg-div",
                                children=dashboard_train_charts.render(themetoken),  # 传入主题令牌
                                style=style(
                                    padding=15,
                                    width="100%",
