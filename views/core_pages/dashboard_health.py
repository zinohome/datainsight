...
import callbacks.core_pages_c.dashboard_health_c
from views.core_pages import dashboard_health_charts
            ...
            [
                html.Div(id="fault-main-bg-div",
                        children=[
                            ...
                            html.Div(
                                id="main-bg-div",
                                children=dashboard_health_charts.render(themetoken),  # 传入主题令牌
                                style=style(
                                    padding=15,
                                    width="100%",
