            ...
            [
                ...
                fac.AntdCol(
                    macda_card(
                        ...
                        description="时间范围：今日",
                        chart=fact.AntdPie(
                            id="param_today-sales-class-chart",
                            data=[
                                {
                                    "type": "家用电器",
                                    "value": 4544,
                ...
                fac.AntdCol(
                    macda_card(
                        ...
                        chart=fact.AntdWordCloud(
                            id="param_today-hot-search-wordcloud",
                            data=[
                    ...
                    macda_card(
                        ...
                        chart=fac.AntdRow(
                            [
                                ...
                                fac.AntdCol(
                                    fact.AntdPie(
                                        id="param_today-comment-wordcloud-chart-1",
                                        data=[{"value": 75}],
                                        angleField="value",
                                        radius=0.3,
                                        innerRadius=0.75,
                                ...
                                fac.AntdCol(
                                    fact.AntdPie(
                                        id="param_today-comment-wordcloud-chart-2",
                                        data=[{"value": 60}],
                                        angleField="value",
                                        radius=0.3,
                                        innerRadius=0.75,
                                ...
                                fac.AntdCol(
                                    fact.AntdPie(
                                        id="param_today-comment-wordcloud-chart-3",
                                        data=[{"value": 85}],
                                        angleField="value",
                                        radius=0.3,
                                        innerRadius=0.75,
                                ...
                                fac.AntdCol(
                                    fact.AntdPie(
                                        id="param_today-comment-wordcloud-chart-4",
                                        data=[{"value": 90}],
                                        angleField="value",
                                        radius=0.3,
                                        innerRadius=0.75,
                ...
                fac.AntdCol(
                    macda_card(
                        ...
                        chart=fact.AntdColumn(
                            id="param_today-conversion-chart",
                            data=[
                                {
                                    "action": "浏览网站",
                                    "pv": 50000,
