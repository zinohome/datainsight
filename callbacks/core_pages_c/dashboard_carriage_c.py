...
# 页面数据更新回调
@callback(
    Output('carriage_update-datetime', 'children'),
    Output('carriage_online-chart-1', 'data'),
    Output('carriage_online-chart-1', 'annotations'),
    Output('carriage_online-chart-2', 'data'),
    Output('carriage_online-chart-2', 'annotations'),
    Output('carriage_online-chart-3', 'data'),
    Output('carriage_online-chart-3', 'annotations'),
    Output('carriage_online-chart-4', 'data'),
    Output('carriage_online-chart-4', 'annotations'),
    Output('carriage_operation-data-chart', 'data'),
    Output('carriage_energy-chart', 'data'),
    Output('carriage_today-sales-class-chart', 'data'),
    Output('carriage_today-hot-search-wordcloud', 'data'),
    Output('carriage_today-comment-wordcloud-chart-1', 'data'),
    Output('carriage_today-comment-wordcloud-chart-1', 'annotations'),
    Output('carriage_today-comment-wordcloud-chart-2', 'data'),
    Output('carriage_today-comment-wordcloud-chart-2', 'annotations'),
    Output('carriage_today-comment-wordcloud-chart-3', 'data'),
    Output('carriage_today-comment-wordcloud-chart-3', 'annotations'),
    Output('carriage_today-comment-wordcloud-chart-4', 'data'),
    Output('carriage_today-comment-wordcloud-chart-4', 'annotations'),
    Output('carriage_today-conversion-chart', 'data'),
    Input('carriage_update-data-interval', 'n_intervals'),
