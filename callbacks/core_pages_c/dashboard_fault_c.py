...
@callback(
    ...
    Output('fault_online-chart-1', 'data'),
    Output('fault_online-chart-1', 'annotations'),
    Output('fault_online-chart-2', 'data'),
    Output('fault_online-chart-2', 'annotations'),
    Output('fault_online-chart-3', 'data'),
    Output('fault_online-chart-3', 'annotations'),
    Output('fault_online-chart-4', 'data'),
    Output('fault_online-chart-4', 'annotations'),
    Output('fault_operation-data-chart', 'data'),
    Output('fault_energy-chart', 'data'),
    Output('fault_today-sales-class-chart', 'data'),
    Output('fault_today-hot-search-wordcloud', 'data'),
    Output('fault_today-comment-wordcloud-chart-1', 'data'),
    Output('fault_today-comment-wordcloud-chart-1', 'annotations'),
    Output('fault_today-comment-wordcloud-chart-2', 'data'),
    Output('fault_today-comment-wordcloud-chart-2', 'annotations'),
    Output('fault_today-comment-wordcloud-chart-3', 'data'),
    Output('fault_today-comment-wordcloud-chart-3', 'annotations'),
    Output('fault_today-comment-wordcloud-chart-4', 'data'),
    Output('fault_today-comment-wordcloud-chart-4', 'annotations'),
    Output('fault_today-conversion-chart', 'data'),
