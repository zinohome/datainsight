...
@callback(
    [Output('h_fault-warning-table', 'data'),
     Output('h_fault-warning-table', 'pagination')],
    [Input('h_url-params-store', 'data'),
     Input('h_query_button', 'nClicks'),
     Input('h_fault-warning-table', 'pagination')],
    [State('h_train_no', 'value'),
     State('h_carriage_no', 'value'),
     State('h_fault_type', 'value'),
